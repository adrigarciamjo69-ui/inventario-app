...
async function initDB() {
  ...
  try {
    ...
    await client.query(`
      ...
      -- Agentes de inventario (modo push) para delegaciones inalcanzables.
      -- El token solo se guarda como SHA-256; jamas en claro.
      ...
      ALTER TABLE scan_jobs ADD COLUMN IF NOT EXISTS agent_id INTEGER REFERENCES scan_agents(id) ON DELETE SET NULL;
