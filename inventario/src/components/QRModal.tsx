...
export default function QRModal({
  assetId, brand, model, serialNumber, category, status,
  assignedTo, department, price, purchaseDate, purchaseOrder, notes, onClose,
}: Props) {
    ...
    <div className="fixed inset-0 z-[60] flex items-center justify-center p-4 bg-black/70 backdrop-blur-sm">
      <div className="bg-gray-900 border border-gray-800 rounded-2xl w-full max-w-sm shadow-2xl">
        ...
        <p className="text-xs text-gray-500 text-center px-6 pb-2">
          Escanea para ver todos los datos del activo
        </p>
