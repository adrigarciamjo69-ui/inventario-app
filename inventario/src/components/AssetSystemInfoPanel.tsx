        ...
        <div className="flex items-center gap-2 text-xs text-gray-400">
          ...
          {info && info.scanned_at ? (
            <span>
              ...
              {info.source === 'agent' && (
                <span title="Este activo recibe datos en directo desde un agente endpoint instalado en el equipo. Los escaneos de red no sobreescribiran esta informacion."
                  className="ml-2 px-1.5 py-0.5 text-[10px] bg-green-500/15 text-green-300 border border-green-500/30 rounded inline-flex items-center gap-1">
                  <Server className="w-3 h-3" /> Gestionado por agente
                </span>
              )}
            </span>
          ) : (
