...
// AGENTES REMOTOS (delegaciones / endpoints Windows-Linux)
export const getAgents = () => apiClient.get('/agents');
export const createAgentToken = (data: object) => apiClient.post('/agents/tokens', data);
export const updateAgentToken = (id: number, data: object) => apiClient.put(`/agents/tokens/${id}`, data);
export const regenerateAgentToken = (id: number) => apiClient.post(`/agents/tokens/${id}/regenerate`);
export const deleteAgentToken = (id: number) => apiClient.delete(`/agents/tokens/${id}`);
export const getAgentReports = () => apiClient.get('/agents/reports');
