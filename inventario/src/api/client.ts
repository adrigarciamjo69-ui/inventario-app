...
// AGENTS (agentes de inventario push para delegaciones)
export const getAgents = () => apiClient.get('/agents');
export const createAgent = (data: object) => apiClient.post('/agents', data);
export const updateAgent = (id: number, data: object) => apiClient.put(`/agents/${id}`, data);
export const deleteAgent = (id: number) => apiClient.delete(`/agents/${id}`);
export const rotateAgentToken = (id: number) => apiClient.post(`/agents/${id}/rotate-token`);
